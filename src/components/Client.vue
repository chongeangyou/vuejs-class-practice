  ...
  <section class="client_section layout_padding">
    <div class="container">
      ...
      <div class="carousel-wrap ">
        ...
        <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-1065px, 0px, 0px); transition: 0.25s; width: 2840px;"><div class="owl-item cloned" style="width: 335px; margin-right: 20px;"><div class="item">
            <div class="box">
              <div class="img-box">
